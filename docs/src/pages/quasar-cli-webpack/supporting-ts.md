...
```tabs
<<| bash Yarn |>>
$ yarn add --dev eslint@8 @typescript-eslint/parser @typescript-eslint/eslint-plugin
...
# you might also want to install the `eslint-plugin-vue` package.
<<| bash Bun |>>
$ bun add --dev eslint@8 @typescript-eslint/parser @typescript-eslint/eslint-plugin
# you might also want to install the `eslint-plugin-vue` package.
```
